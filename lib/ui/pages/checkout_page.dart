...
class CheckoutPage extends StatelessWidget {
    CheckoutPage({Key? key,required this.selectedSeats,required this.totalPrice, this.grandTotal}) : super(key: key);
  ...
  void fetchTotalBalance() async {
      try {
        int totalBalance = await TransactionService.getTotalBalance();
    ...
    FontWeight black = FontWeight.w900;
      ...
      void performTransaction(BuildContext context) async {
        try {
          ...
          TransactionModel transaction = await TransactionService.createTransaction(
            total: total,
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        FutureBuilder<int>(
                          future: TransactionService.getTotalBalance(),
